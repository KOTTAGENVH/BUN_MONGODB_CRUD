import{Kind as e}from"@sinclair/typebox";import{Value as r}from"@sinclair/typebox/value";import{TypeCompiler as t}from"@sinclair/typebox/compiler";import{isNotEmpty as o}from"./handler";let a=e=>e&&"object"==typeof e&&!Array.isArray(e);export const replaceUrlPath=(e,r)=>{let t=new URL(e);return t.pathname=r,t.toString()};let n=e=>"function"==typeof e&&/^\s*class\s+/.test(e.toString())||// Handle import * as Sentry from '@sentry/bun'
